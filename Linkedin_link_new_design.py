...
workbook = Workbook('gambling_1-10_1000.xlsx')
...
path = 'C:\\Users\\Admin\\Desktop\\Linkedin_files\\Gambling\\1-10_1000\\'
...
for i in range (len(finalpath)):
    ...
    for a in soup.find_all('a', {'class': 'name-link account-link'}):
        m = re.search("Id=.+&", a['href'])
        b= m.group(0)[3:]
        linkedin_link.append('https://www.linkedin.com/company/'+str(b).rsplit('&', 4)[0])
